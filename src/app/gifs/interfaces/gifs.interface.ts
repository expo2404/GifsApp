// To parse this data:
//
//   import { Convert, GifsAplicacion } from "./file";
//
//   const gifsAplicacion = Convert.toGifsAplicacion(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface GifsAplicacion {
  data:       gif[];
...
export enum SourceTLD {
  Empty = "",
  InfiniteDaydreamingTumblrCOM = "infinite-daydreaming.tumblr.com",
...
export class Convert {
  public static toGifsAplicacion(json: string): GifsAplicacion {
      return cast(JSON.parse(json), r("GifsAplicacion"));
  }

  public static gifsAplicacionToJson(value: GifsAplicacion): string {
      return JSON.stringify(uncast(value, r("GifsAplicacion")), null, 2);
  }
}
...
const typeMap: any = {
  ...
  "SourceTLD": [
      "",
      "infinite-daydreaming.tumblr.com",
